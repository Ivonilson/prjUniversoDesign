							...
							?>
								<tr>
									<form method="post">
										...
										<td align="center"><a href="/?pagina=editar-os&cod_os=<?= $value['cod_os'] ?>&form=pesquisa-por-data-receb" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Atualizar" target=""><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
