...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="/"><span>Universo Design</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#features">Produtos e Serviços</a></li>
          <li><a class="nav-link scrollto" href="#gallery">Nossos Clientes</a></li>
          <li><a class="nav-link scrollto" href="#contact">Contatos</a></li>
          <li><a class="nav-link scrollto" href="/?pagina=login">Área Restrita</a></li>
    ...
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="site/assets/img/vertical.jpg" class="img-fluid animated imagem" alt="">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            ...
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="300">
              ...
              <p class="description">Estamos sempre prontos para atendê-los. Solicite um orçamento através da seção de Contatos.</p>
            </div>
        ...
        <div class="row" data-aos="fade-left">
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="50">
             ...
             <img src="site/assets/img/gallery/banner.png">
              <h3><a href="#">&nbspBanners</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
        ...
        <div class="row g-0" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
              <a href="site/assets/img/gallery/gallery-5.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-5.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="350">
              <a href="site/assets/img/gallery/gallery-6.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-6.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="400">
              <a href="site/assets/img/gallery/gallery-7.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-7.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="site/assets/img/gallery/gallery-8.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-8.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="site/assets/img/gallery/gallery-9.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-9.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="site/assets/img/gallery/gallery-10.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-10.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="site/assets/img/gallery/gallery-11.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-11.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="site/assets/img/gallery/gallery-12.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-12.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="site/assets/img/gallery/gallery-13.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-13.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="site/assets/img/gallery/gallery-14.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-14.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="site/assets/img/gallery/gallery-15.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-15.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="site/assets/img/gallery/gallery-16.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-16.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="site/assets/img/gallery/gallery-26.jpg" class="gallery-lightbox">
                <img src="site/assets/img/gallery/gallery-26.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
        ...
        <div class="row" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="site/assets/img/team/team-1.jpg" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="200">
              <div class="pic"><img src="site/assets/img/team/team-2.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="300">
              <div class="pic"><img src="site/assets/img/team/team-3.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
