...
class Receita {
...

	{
			...
			$statement = "INSERT INTO tbl_receita (id_receita, tipo, detalhamento, valor, forma_pagamento, data_referencia, data_processamento, ano, usuario) VALUES (:id_receita, :tipo, :detalhamento, :valor, :forma_pagamento, :data_referencia, CURRENT_TIMESTAMP, :ano, :usuario)";
